...
class transaction(models.Model):
    ...
    #    status = models.CharField(max_length=1, choices=STATUS, editable=False)
        ...
        def start_transaction(self, user, Tr_type, from_acc_no, to_acc_no, ammount):
...
'''                            to_acc.do_transaction(2,ammount,self,False)
                            from_acc.do_transaction(1,ammount,self,False)'''
                            transactions = transaction(fromUser = from_acc, toUser = to_acc, )
