...
=======
# Generated by Django 2.1.2 on 2018-10-29 07:48
>>>>>>> 09a22451869c95e9c4ca51f398ee04a2044f2239
=======
# Generated by Django 2.1.2 on 2018-10-30 13:12
>>>>>>> 9111cfa32171fca90d53c59370abc82f3f757431
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('O', 'Active'), ('S', 'Suspended')], default='O', max_length=1)),
                ('linked', models.CharField(choices=[('O', 'Active'), ('S', 'Suspended')], default='O', max_length=1000)),
                ('designation', models.CharField(choices=[('user', 'User: permission to do account operations'), ('merchant', 'Merchant:create payments for their users'), ('employee', 'Employee: check the employee dashboard'), ('manager', 'Manager : Manager/Staff, critical transactions'), ('admin', 'admin')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Address', models.CharField(max_length=512)),
                ('city', models.CharField(max_length=256)),
                ('isModified', models.CharField(default='0', max_length=1)),
            ],
        ),
    ]
